...
La figure \ref{fig:reset-arc-petri-net} nous montre un exemple concret d'une telle construction. La relation de flots avec tout arc de $p$ est donc reproduite à l'identique pour $p'$, à l'exception de l'arc inhibiteur dont la liaison avec $p$ est retirée pour la transformer en arc de reset sur $p'$.
