...
L'introduction des réseaux de Petri continus étendus nous a permis de développer une nouvelle sémantique originale. Celle-ci avait pour objectif d'abstraire le comportement discret des réseaux de Petri discrets étendus dans la perspective d'obtenir de nouveaux résultats de décidabilité.

Toutefois, nous avons montré dans le théorème \ref{theorem:inh-petri-minsky-equivalence} que le problème d'accessibilité dans les réseaux continus à arcs inhibiteurs demeure indécidable. En effet, ceux-ci sont en réalité équivalents à des machines de Minsky, un modèle de calcul ayant une puissance équivalente aux machines de Turing. Pour ce faire, nous avons trouvé une construction de réseaux continus qui permette de simuler uniquement des séquences de tirs discrets et ainsi de simuler ces machines dont le comportement est également discret. Par conséquent, nous avons créé un lien entre le problème de l'arrêt de ces dernières et l'accessibilité de nos réseaux : elle est ainsi indécidable.
