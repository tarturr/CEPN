...
\textbf{Contributions.} Dans cet article, nous introduisons une nouvelle sémantique combinant les extension structurelles avec le domaine continu, que nous nommons les Réseaux de Petri Continus Étendus (CEPN). Notre objectif principal est de tracer la frontière de décidabilité du problème d'accessibilité au sein de ce nouveau modèle.
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|c|c|}
        \hline
        \textbf{Extension d'arcs} & \textbf{RdP Discrets} & \textbf{RdP Continus Étendus}\\
        \hline
